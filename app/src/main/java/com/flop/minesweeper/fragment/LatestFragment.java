...
import com.flop.minesweeper.adapter.LatestAdapter;
...
public class LatestFragment extends Fragment {
    ...
    //构造函数传入参数
    public static LatestFragment newInstance(String pageName, int itemCount) {
        LatestFragment newFragment = new LatestFragment();
...
//                    time = System.currentTimeMillis();
    ...
    private void setVideoItem() {
        ...
        //设置适配器
        mRecyclerView.setAdapter(new LatestAdapter(mActivity, mData));
